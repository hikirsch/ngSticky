  ...
  module.directive('sticky', ['$window', '$timeout', function ($window, $timeout) {
      return {
        ...
        link: function linkFn($scope, $elem, $attrs) {
          ...
          var placeholderClass = $attrs.placeholderClass || 'ngSticky-placeholder';
          ...
          function createPlaceholder() {
            if (usePlaceholder) {
              ...
              placeholder.css('margin-top', parseInt( computedStyle.marginTop, 10 ) + 'px');
              placeholder.css('margin-bottom', parseInt( computedStyle.marginBottom, 10 ) + 'px');
